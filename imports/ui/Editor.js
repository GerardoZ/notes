        ...
        if(this.props.note){
            return (
                <div className="editor">
                    <input className="editor__title" type="text" value={this.state.title} placeholder="Title here" onChange={this.handleTitleChange.bind(this)}/>
                    ...
                    <div><button className="button button--secondary" onClick={this.handleDelete.bind(this)}>Delete note</button></div>
                </div>
            );
        }else{
            return (
